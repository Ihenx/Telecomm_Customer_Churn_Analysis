if OBJECT_ID('bronze.telecom_customer_churn') is not null
	drop table telecom_customer_churn
go

create table bronze.telecom_customer_churn(
...
if OBJECT_ID('bronze.Telecom_ZipCode_Population', 'U') is not null
	drop table bronze.Telecom_ZipCode_Population;
go

create table bronze.Telecom_ZipCode_Population(
Zipcode int,
Population int
);
